...
\newcommand{\zeit}[1]{\textnormal{\footnotesize\color{bg!90!white}\textsf{#1}}}
...
\begin{titlepage}
  ...
  \begin{minipage}{0.78\textwidth}
    ...
    {\sffamily\footnotesize\color{muted}Voxelisierte Kugel mit Durchmesser 12, von Pixel Round erzeugt.}
  \end{minipage}
  \vspace{1.0cm}\\
  {\color{rule}\rule{0.6\textwidth}{0.6pt}\par}
  \vspace{1.0cm}
...
\end{subfigure}
\caption{Derselbe Kreis mit Durchmesser 20 in den drei Algorithmen. Bei größeren Durchmessern sind die Unterschiede subtiler als bei kleineren.}
\label{fig:comp-d20}
\end{figure}
...
\begin{subfigure}[t]{0.42\linewidth}\centering
  ...
  \caption{Kugel $D = 12$ ($r_x = r_y = r_z = 6$).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.42\linewidth}\centering
  \includegraphics[width=\linewidth]{fig08_3d_ellipsoid.png}
  \caption{Ellipsoid $W = 20, H = 10, D = 12$.}
\end{subfigure}
\caption{3D-Voxelisierung. Jeder Würfel ist ein Voxel, dessen Mittelpunktkoordinate gegen die implizite Gleichung geprüft wird.}
\label{fig:3d-shapes}
\end{figure}
...
\begin{subfigure}[t]{0.31\linewidth}\centering
  ...
  \caption{Y-Schnitt bei 50\% ($y \geq 5$ verworfen)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig10_3d_cut_x50.png}
  \caption{X-Schnitt bei 50\% ($x \geq 10$ verworfen)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig11_3d_cut_diag50.png}
  \caption{Diagonalschnitt ($x + y \geq 15$ verworfen)}
\end{subfigure}
\caption{Drei ebene Schnitte am selben Ellipsoid ($W = 20, H = 10, D = 12$), je 50\% Volumen beibehaltend. Beachten Sie das treppenförmige Muster des Diagonalschnitts.}
\label{fig:cortes}
\end{figure}
