...
\newcommand{\tiempo}[1]{\textnormal{\footnotesize\color{bg!90!white}\textsf{#1}}}
...
\begin{titlepage}
  ...
  \begin{minipage}{0.78\textwidth}
    ...
    {\sffamily\footnotesize\color{muted}Esfera de diámetro 12 voxelizada por Pixel Round.}
  \end{minipage}
  \vspace{1.0cm}\\
  {\color{rule}\rule{0.6\textwidth}{0.6pt}\par}
  \vspace{1.0cm}
...
\begin{subfigure}[t]{0.31\linewidth}\centering
  ...
  \caption{\emph{Umbral}}
\end{subfigure}
\caption{Misma circunferencia de diámetro 20 en los tres algoritmos. Con diámetros mayores las diferencias son más sutiles que en diámetros pequeños.}
\label{fig:comp-d20}
\end{figure}
...
\begin{subfigure}[t]{0.42\linewidth}\centering
  ...
  \caption{Esfera $D = 12$ ($r_x = r_y = r_z = 6$).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.42\linewidth}\centering
  \includegraphics[width=\linewidth]{fig08_3d_ellipsoid.png}
  \caption{Elipsoide $W = 20, H = 10, D = 12$.}
\end{subfigure}
\caption{Voxelización 3D. Cada cubo es un vóxel cuya coordenada de centro se prueba contra la ecuación implícita.}
\label{fig:3d-shapes}
\end{figure}
...
\begin{subfigure}[t]{0.31\linewidth}\centering
  ...
  \caption{Corte Y al 50\% ($y \geq 5$ descartado)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig10_3d_cut_x50.png}
  \caption{Corte X al 50\% ($x \geq 10$ descartado)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig11_3d_cut_diag50.png}
  \caption{Corte diagonal ($x + y \geq 15$ descartado)}
\end{subfigure}
\caption{Tres cortes planos en el mismo elipsoide ($W = 20, H = 10, D = 12$), preservando cada uno el 50\% del volumen. Note el patrón escalonado del corte diagonal.}
\label{fig:cortes}
\end{figure}
