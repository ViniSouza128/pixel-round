...
\newcommand{\tempo}[1]{\textbf{\small\color{muted}\textsf{#1}}}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.65\textwidth]{fig04_2d_ellipse_24x12.png}
...
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig08_3d_ellipsoid.png}
  \caption{\emph{Clássico} (contraste forte)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig12_3d_style_smooth.png}
  \caption{\emph{Suave} (contraste reduzido)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig13_3d_style_blocks.png}
  \caption{\emph{Blocos} (com sulcos)}
\end{subfigure}
\caption{Três estilos de sombreamento 3D para o mesmo elipsóide. \emph{Clássico} marca bem a luz e a sombra; \emph{Suave} dá um aspecto mais uniforme; \emph{Blocos} introduz uma reentrância geométrica nas faces, útil para visualizar a estrutura cúbica.}
\label{fig:styles}
\end{figure}
