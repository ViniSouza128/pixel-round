...
\newcommand{\duree}[1]{\textnormal{\footnotesize\color{bg!90!white}\textsf{#1}}}
...
\begin{titlepage}
  ...
  \begin{minipage}{0.78\textwidth}
    ...
    {\sffamily\footnotesize\color{muted}Sphère de diamètre 12 voxelisée par Pixel Round.}
  \end{minipage}
  \vspace{1.0cm}\\
  {\color{rule}\rule{0.6\textwidth}{0.6pt}\par}
  \vspace{1.0cm}
...
\begin{subfigure}[t]{0.31\linewidth}\centering
  ...
  \caption{\emph{Seuil}}
\end{subfigure}
\caption{Même cercle de diamètre 20 dans les trois algorithmes. Aux grands diamètres, les différences sont plus subtiles qu'aux petits diamètres.}
\label{fig:comp-d20}
\end{figure}
...
\begin{subfigure}[t]{0.42\linewidth}\centering
  ...
  \caption{Sphère $D = 12$ ($r_x = r_y = r_z = 6$).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.42\linewidth}\centering
  \includegraphics[width=\linewidth]{fig08_3d_ellipsoid.png}
  \caption{Ellipsoïde $W = 20, H = 10, D = 12$.}
\end{subfigure}
\caption{Voxelisation 3D. Chaque cube est un voxel dont la coordonnée du centre est testée contre l'équation implicite.}
\label{fig:3d-shapes}
\end{figure}
...
\begin{subfigure}[t]{0.31\linewidth}\centering
  ...
  \caption{Coupe Y à 50\% ($y \geq 5$ écarté)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig10_3d_cut_x50.png}
  \caption{Coupe X à 50\% ($x \geq 10$ écarté)}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}\centering
  \includegraphics[width=\linewidth]{fig11_3d_cut_diag50.png}
  \caption{Coupe diagonale ($x + y \geq 15$ écarté)}
\end{subfigure}
\caption{Trois coupes planes sur le même ellipsoïde ($W = 20, H = 10, D = 12$), chacune préservant 50\% du volume. Notez le motif en escalier de la coupe diagonale.}
\label{fig:cortes}
\end{figure}
